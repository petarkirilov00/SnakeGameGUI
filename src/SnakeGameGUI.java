...
public class SnakeGameGUI extends JPanel implements Runnable {
    ...
    boolean hitsWall() {
        ...
        int nextCol = head.x + movement.x;
        int nextRow = head.y + movement.y;
    ...
    void growSnake() {
        ...
        int x = tail.x + movement.x;
        int y = tail.y + movement.y;
    ...
    void drawSnake(Graphics2D g) {
        ...
        g.setColor(energy < 500 ? Color.red : Color.pink);
        Point head = snake.get(0);
    ...
    void drawScore(Graphics2D g) {
        ...
        String s = format("Hi-Score: %d    Score: %d", upScore, score);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(
                () -> {
                    ...
                    mainFrame.setTitle("Snake GUI");
                    mainFrame.setResizable(true);
                    mainFrame.add(new SnakeGameGUI(), BorderLayout.CENTER);
                    mainFrame.pack();
